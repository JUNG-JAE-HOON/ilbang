...
<html lang="ko">
  <head>
    ...
    <title>일방 - 구인구직(일당제) 서비스</title>
    <link rel="stylesheet" href="http://il-bang.com/pc_renewal/css/bootstrap.css?ver=1.1.1">
    <link rel="stylesheet" href="http://il-bang.com/pc_renewal/css/default.css?ver=1.2.4">
    <link rel="stylesheet" href="http://il-bang.com/pc_renewal/css/hwajin.css?ver=1.0.6">
    ...
    <div class="container bb ht50 bg center wdfull">
        <div class="pg_rp">
            <ul class="nav nav-tabs ml35 fl mTopNav">
                ...
                <li class="dropdown ht46">
                    <a class="nav_top_txt" href="http://il-bang.com/pc_renewal/jijeom/jijeomApply.php">지점신청 </a>
                </li>
            </ul>
            <ul class="nav navbar-nav navbar-right nav_right_apply  mtopNav-right">
                <li><a href="javascript:applicationCheck(0)" class="bold" style="padding: 10px 25px;"><img src="http://il-bang.com/pc_renewal/images/person.png" alt="구직신청아이콘" class="navIcon img-responsive" />구직 신청</a></li>
                <li id="index_guinCheck">
                    <a href="#" onclick="indexGuinCheck(1); return false;" class="bold" style="padding: 10px 25px;">
