...
*/
    ...
    $sql  = " SELECT B.work_resume_data_no, B.work_employ_data_no, C.no as resumeNo, E.age, C.title, C.keyword, C.pay, C.career, C.content, C.wdate, C.time, C.member_no,  D.name, E.sex ";
    $sql .= " FROM work_employ_data A, work_join_list B, work_resume_data C, member D, member_extend E ";
    $sql .= " WHERE 1=1 ";
    $sql .= " AND A.uid   = '$uid' ";
    $sql .= " AND A.no    = B.work_employ_data_no ";
