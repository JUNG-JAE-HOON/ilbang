...
<script>
	...
	function getResumeReviewInfo(){
		...
		var employNo = '<?php echo $_GET["employNo"]?>';
   		...
   		$.ajax({
	             type: 'post',
	             dataType: 'json',
	             url: '../ajax/gujik/getEmployReviewData.php',
	...
	function insertReview(){
		...
		$.ajax({
	             type: 'post',
	             dataType: 'json',
	             url: '../ajax/gujik/insertEmployReview.php',
	    ...
	    <div role="tabpanel" class="tab-pane active mt10" id="gujikTab1">
			...
			<div class="gujikDetSect1 mt50">
				<div class="border-navy">
					...
					<ul class="detailInfoUl_guin pr">
						<li class="bb padding">
							<span class="di w10">구인자</span><span id="name"></span>
						</li>
						<li class="bb padding">
							<span class="di w10">성별/나</span><span id="sexNage"></span>
						</li>
						<li class="padding">
						...
						<li class="pa tc" style="left:20px; top:35px; width:18%">
							<img id="profileImg"  alt="" style="width: 205px; height:54px;">
						</li>
					</ul>
				</div>
			</div> 
			...
			<select id="workDate" class="mr15 smallSelect" onchange="getReviewContent()">
	      	...
	      	<div class="reviewWrtWrap mt30 mb50">
	                ...
	                <button onclick="insertReview()" class="btn btn-primary reviewWrtBtn fl">리뷰등록</button>
	            <div class="clear"></div>		
	      	</div>
