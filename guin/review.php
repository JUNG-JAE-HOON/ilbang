...
<script>
    ...
    function reviewDelete(no) {
        if(confirm("정말 삭제하시겠습니까?\n(삭제된 데이터는 복구할 수 없습니다.)")) {
            $.ajax({
                type: 'post',
                dataType: 'json',
                url: '../ajax/item/employReviewDelete.php',
                data: { no: no },
                success: function(data) {
                    alert(data);
                    getEmployReviewInfo();
    ...
    function getReviewContent() {
        ...
        $.ajax({
            type: 'post',
            dataType: 'json',
            url: '../ajax/guin/getEmployReviewContent.php',
                ...
                <div class="gujikDetSect1 mt50">
                    <div class="border-navy">
                        ...
                        <ul class="detailInfoUl_gujik pr">
                            <li class="bb padding">
                                <span class="di w10">구인자</span><span id="tt_company"></span>
                            </li>
                            <li class="bb padding">
                                <span class="di w10">성별 / 나이</span><span id="sexNage"></span>
                            </li>
                            <li class="padding">
                                <span class="di w10 fl">평점</span>
                                <div class="rateAvg fl noPadding mr5"></div>
                                <span class="fc fl" id="totalScore"></span>&nbsp;/ 5.0점
                            </li>
                            <li class="pa tc" style="left:35px; top:20px;"><img id="profileImg" alt="프로필"></li>
                        </ul>
                    </div>
                </div> 
