        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data.listData == null) {
                    document.getElementById("emergencyGuinListArea1").innerHTML = '<div class="c888 f14" style="padding: 10px 8px;">긴급 구인 리스트가 없습니다.</div>';
                } else {
                    for(var i=0; i<4; i++) {
                        if(data.listData.length <= i ) continue;

                        if(data.listData[i].img_url == null || data.listData[i].img_url == '' ) {
                            var company = '<div class="f20 bold text-cut">' + data.listData[i].company + '</div>';
                        } else {
                            var company = '<img src="guinImage/' + data.listData[i].img_url + '" alt="" class="wh144">';
                        }
                        ...
                        +  '<h5 class="f_grey bold text-cut" style="margin-right: 8.3333333%;">'+data.listData[i].title+'</h5>'
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data.vipList == null) {
                    ...
                    if(data.recentList.length <= 8) {
                        var length = data.recentList.length;
                    } else {
                        var length = 8;
                    }
                    ...
                    for(var i=0; i<length; i++) {
                        document.getElementById("vipList").innerHTML
                        += '<a href="./guin/view/tab1.php?employNo=' + data.recentList[i].no + '" class="di oh rmk-vip-list pr cp" align="center">'
                        + '<div class="di pa plusIcon glyphicon glyphicon-plus f25 bold fc" align="center"></div>'
                        + data.recentList[i].logo
                        + '<div align="left" class="col-md-offset-1 col-lg-offset-1 mt30">'
                        + '<h5 class="f_grey bold text-cut" style="margin-bottom: 8px; margin-right: 8.3333333%;">' + data.recentList[i].title + '</h5>'
                        + '<p>' + data.recentList[i].work1 + ' > ' + data.recentList[i].work2 + '</p>'
                        + '<p><span class="bold">지역</span> : ' + data.recentList[i].area + '</p>'
                        + '<p class="f16"><span class="bold fc">' + data.recentList[i].pay + '</span>원</p>'
                        + '</div>'
                        + '</a>';
                    }
                } else {
                    for(var i=0; i<data.vipList.length; i++) {
                        document.getElementById("vipList").innerHTML
                        += '<a href="./guin/view/tab1.php?employNo=' + data.vipList[i].no + '" class="di oh rmk-vip-list pr cp" align="center">'
                        + '<div class="di pa plusIcon glyphicon glyphicon-plus f25 bold fc" align="center"></div>'
                        + data.vipList[i].logo
                        + '<div align="left" class="col-md-offset-1 col-lg-offset-1 mt30">'
                ...
                if(data.platinumList == null) {
                    ...
                    for(var i=0; i<length; i++) {
                        document.getElementById("platinumList").innerHTML
                        += '<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 border cp rmk-plat-wrap" onclick=location.href="./guin/view/tab1.php?employNo=' + data.recentList[i].no + '">'
                        + '<div class="vm mormalLogo fl f18 text-cut tc bold" style="width: 144px; margin-top: 43px;">' + data.recentList[i].company + '</div>'
                        + '<div class="fl pl30 rmk-plat-info1">'
                        + '<h5 class="f_grey bold">' + data.recentList[i].title + '</h5>'
                        + '<p class="pt5"><b>담당 업무</b> : '+ data.recentList[i].business + '</p>'
                        + '<p><span class="ilbangBadge mr5"><b>' + data.recentList[i].work1 + '</b></span>'
                        + '<span class="mr20">' + data.recentList[i].work2 + '</span> ' + data.recentList[i].area + '</p>'
                        + '</div>'
                        + '<div class="rmk-plat-info2 oh tc">'
                        + '<p>' + data.recentList[i].sex + '<p>'
                        + '<p>' + data.recentList[i].age + '<p>'
                        + '<p>' + data.recentList[i].time + '<p>'
                        + '</div>'
                        + '<p class="f16 pa rmk-plat-info3"><span class="bold fc">' + data.recentList[i].pay + '</span>원</p>'
                        + '</div>';
                    }
                } else {
                    for(var i=0; i<data.platinumList.length; i++) {
                        ...
                        + '<div class="vm mormalLogo fl f18 text-cut tc bold" style="width: 144px; margin-top: 43px;">' + data.platinumList[i].company + '</div>'
                        + '<div class="fl pl30 rmk-plat-info1">'
                        + '<h5 class="f_grey bold">' + data.platinumList[i].title + '</h5>'
                ...
                if(data.grandList == null) {
                    ...
                    for(var i=0; i<data.grandList.length; i++) {
                        ...
                        + '<div class="vm mormalLogo fl f18 text-cut tc bold" style="width: 144px; margin-top: 43px;">' + data.grandList[i].company + '</div>'
                        + '<div class="fl pl30 rmk-plat-info1">'
                        + '<h5 class="f_grey bold">' + data.grandList[i].title + '</h5>'
                ...
                if(data.specialList == null) {
                    ...
                    for(var i=0; i<length; i++) {
                        document.getElementById("specialList").innerHTML
                        += '<a href="guin/view/tab1.php?employNo=' + data.recentList[i].no + '">'
                        + '<ul class="oh noPadding bb pdt6">'
                        + '<li class="rmk-special-li1 fl tc oh">'
                        + '<div class="bold mt15 mb20">' + data.recentList[i].area + '</div>'
                        + '</li>'
                        + '<li class="rmk-special-li2 fl" style="line-height: 1;">'
                        + '<div class="mt15 mb20" style="padding-top: 1px;">'
                        + '<span class="ilbangBadge" style="line-height: 15px;"><b>' + data.recentList[i].work2 + '</b></span>'
                        + '<span class="di text-cut guinDesc margin-verti ml5" style="padding-top: 1px">' + data.recentList[i].business + '</span>'
                        + '</div>'
                        + '</li>'
                        + '<li class="rmk-special-li3 fl tc">'
                        + '<p class="mt15 mb20 text-cut">' + data.recentList[i].company + '</p>'
                        + '</li>'
                        + '<li class="rmk-special-li4 fl tc">'
                        + '<div class="rmk-pay mt15 mb20">'
                        + '<span class="border-grey payBedge mr5">일당</span>'
                        + '<span>' + data.recentList[i].pay + '원</span>'
                        + '</div>'
                        + '</li>'
                        + '</ul>'
                        + '</a>';
                    ...
                    for(var i=0; i<data.specialList.length; i++) {
                        ...
                        + '</li>'
                        + '<li class="rmk-special-li3 fl tc">'
                        + '<p class="mt15 mb20 text-cut">' + data.specialList[i].company + '</p>'
                        + '</li>'
                        + '<li class="rmk-special-li4 fl tc">'
                        + '<div class="rmk-pay mt15 mb20">'
                        + '<span class="border-grey payBedge mr5">일당</span>'
    ...
    function randomGuinList() {
        $.ajax({
            ...
            success: function (data) {
                ...
                = '<a class="di oh" href="' + data.specialGuin.url + '" style="width:60%;">'
                ...
                + '<li class="fl f_grey">'
                + '<a href="' + data.specialGuin.url + '">정보 보기 </a>'
                + '</li>'
                ...
                var content = '<a href="guin/view/tab1.php?employNo=' + data.randomGuin.no + '">';
                content += '<span class="rmk-badge di bold" style="line-height: 1; padding: 3px 8px; margin-right: 7px;">' + data.randomGuin.work + '</span>';

                if(data.randomGuin.work == "백화점/마트일방") {
                    content += '<span class="text-cut di vm" style="padding-bottom: 2px; max-width: 55%;">' + data.randomGuin.title + '</span>';
                } else {
                    content += '<span class="text-cut di vm" style="padding-bottom: 2px; max-width: 65%;">' + data.randomGuin.title + '</span>';
                }

                content += '</a>';

                document.getElementById("randomGuin").innerHTML = content;
            }
        });
    }
...
<!-- <div id="myQRmodal" class="modal fade">
    <div class="modal-dialog" style="width: 670px; margin: 20em auto 0;">
        
        <div class="qrModalWrap clear">
            <a href="javascript:closeMainPopup();" class="fr mb10" data-dismiss="modal" aria-hidden="true" style="background-color: black">
        ...
        <a href="javascript:closePopupNotToday('QR', 'QR', 1)" style="font-size: 14px;">
            <div class="tr qrModalWrap-week" style="width: 100%; background-color: #fff; padding: 15px;">오늘 하루 그만보기</div>
        </a>
    </div>
</div> -->
<!-- Modal END! -->
...
<div class="container center wdfull bb pt5 pb5">
    <div class="pg_rp"> 
        <div class="c999 fl pl35">
            <span class="mr5 br15 subNotice">공지1</span>
...
<!-- 퀵배너 -->
    ...
    <div class="sctInner1 oh mt20">
        <!-- 탭 -->
        <div class="count fl oh top-section1">
            <div class="top-sec-ban1 fl" style="width:55.5%; margin-right: 1%;">
              <div class="noPadding">
                
                    <img class="event1" src="images/new-main1.png" alt="" width="100%"> 
                
              </div>
              <div class="noPadding">
                <a class="event-banner oh" href="event/event1.php">
                    <img class="event2" src="images/event1-banner.png" alt="" width="100%">
                </a>
              </div>
              <div class="noPadding">
                <a class="event-banner oh" href="event/event2.php">
                    <img class="event3" src="images/event2-banner.png" alt="" width="100%">
                </a>
              </div>
            </div>
            <script>
            ...
            <div class="top-sec-ban2 fl" style="width:43.5%; box-sizing: border-box;">
                <img src="images/new-main2.png" alt="" width="100%" onclick="location.href='https://play.google.com/store/apps/details?id=net.saltfactory.il_bang'">
            </div>
    ...
    <div class="tabWrap tabWrap1 fl rmk-loginTab oh">
        <div class="login-main">
            ...
            <div>
              <a href="http://tshome.co.kr/" class="oh di w100 ts-banner">
                  <img src="images/new-main3.png" alt="" width="100%" class="mt5">
              </a>
            </div>
        </div>
        <script>
        ...
        <!-- 배너 스와이퍼 -->
        <div class="container-fluid bg_darkgrey mt20 vm mb35" style="height: 40px; border:2px solid #efefef; padding-top:3px">
            <div class="midBanner center"> 
                <div class="tc">
